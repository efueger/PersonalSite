 ...
 * Auth Routes
 */
$app->get('/login', AuthController::class . ':getLogin')->add(new GuestMiddleware($container))->setName('auth.getLogin');
$app->post('/login', AuthController::class . ':postLogin')->add(new GuestMiddleware($container))->setName('auth.postLogin');
$app->get('/logout', AuthController::class . ':logout')->add(new AuthMiddleware($container))->setName('auth.logout');
